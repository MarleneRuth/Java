...
public class CuentaBancariaANT {
    ...
    public CuentaBancariaANT(String titular) {
        this(titular, 0);
    }

    public CuentaBancariaANT(String titular, double saldoInicial) {
    ...
    public static void main(String[] args) {
        CuentaBancariaANT cuenta1 = new CuentaBancariaANT("Juan Pérez", 1000);
        System.out.println("Cuenta creada: " + cuenta1.getNumeroCuenta());
        cuenta1.depositar(500);
        cuenta1.retirar(200);

        CuentaBancariaANT cuenta2 = new CuentaBancariaANT("María López");
